...
import {
  눌러, 매출표아님, 손익표, 합계행, 상계행, 머리글, 밋밋, 주식표, 종속표, 지역표,
} from "./매출표.mjs";
...
function 매출(code) {
  ...
  // 어느 보고서에서 뽑았는지 알고 있으니 기대 배수를 그에 맞춘다.
  const n = String(v.report ?? "");
  const 배수 = /반기보고서/.test(n) ? [0.5, 0.25]
    : /분기보고서/.test(n) ? [0.25, 0.5, 0.75]
    : [1];
