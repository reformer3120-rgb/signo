...
const 금융표 =
  /은행$|증권$|캐피탈$|저축은행$|^미수금$|^보증금$|^매출채권$|^대여금$|^선급금$|^미수수익$|상각후원가|공정가치|현금및현금성|위험회피|^예금$|손보$|화재$|해상$/;
...
const 지재권표 = /^특허(등록|출원)?$|^상표(등록|출원)?$|^디자인(등록)?$|^실용신안$|^PCT$/;
// 연결 상계 행
const 상계행 = /내부매출|연결조정|내부거래|상계제거|매출제거/;
// 표의 머리글이 조각으로 끼어든 것
//   테라뷰  「EOTPR 72.9% · TeraPulse 등 14.9% · TeraCota 12.1% · 제품명 0%」
const 머리글 = /^(제품명|품목|품명|구분|항목|사업부문|부문|종류|매출유형|유형|비고|매출현황|매출액현황|출유형|매출유형및품목)$/;
